...
const stats = [
  { value: "2000+", label: "Students Guided", color: "text-blue-500" },
  { value: "98%", label: "Success Rate", color: "text-green-500" },
  { value: "24/7", label: "Support Available", color: "text-purple-500" },
  { value: "5000+", label: "Mentorship Hours", color: "text-orange-500" },
];
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  {
                    icon: <CircleDollarSign className="w-5 h-5 text-yellow-500" />,
            ...
            >
              <div className="text-center">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {["Code Reviews", "Debugging Help", "Architecture Design", "Deployment Support"].map(
                    (item, index) => (
                      <motion.div
                        key={item}
                        initial={{ scale: 0 }}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-4 py-2 rounded-lg border ${
                    errors.inquiryType ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                  } bg-transparent transition-colors focus:ring-2 focus:ring-blue-500
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
          Whether you're stuck on a coding problem, need career advice, or want
          to discuss project ideas, our team is here to help you succeed in your
          technical journey.
        </p>
